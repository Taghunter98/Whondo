...
from app.property.keywords import store_keywords, delete_keywords, reset_keywords, update_keywords
...
class TestKeywords(unittest.TestCase):
    def testKeywords(self):
        ...
        self.assertTrue(update_keywords(kID,["house", "flat","bungalow",]), "Keywords were not updated")
