...
class VerifyPage extends Comp {
    ...
    hook(){
        ...
        dialogBox.title      = "Please verify you email";
        dialogBox.paragraph1 = "We have sent you an email with a verification link.";
        dialogBox.paragraph2 = "Please check your email or in spam to verify your account.";
